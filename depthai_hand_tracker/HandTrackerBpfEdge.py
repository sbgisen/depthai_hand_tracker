...
class HandTrackerBpf:
    ...
    def __init__(self, input_src=None,
        ...
        self.crop_region = mpu.CropRegion(-self.pad_w, -self.pad_h, -self.pad_w
    ...
    def exit(self):
        ...
        if self.stats:
            ...
            print(
                f"# frames w/ body detection    : {self.nb_frames_body_inference} ({100*self.nb_frames_body_inference/nb_frames:.1f}%)")
            print(
